...
% Iterate through each row in the dataFrontend Technologies
for i = 1:height(data)
    % Split the technologies by comma for the current row and trim spaces
    techs = strtrim(strsplit(data.backendTechnology{i}, ','));
...
title('Distribution of CO2 Emissions by Frameworks/CMS');
xtickangle(45);
...
print -depsc avgImpactbyBackendTechnology.eps